...
import { isEsGlobalMethods, hasOwn } from '../utils';
import { __windowBind__, GARFISH_OPTIMIZE_NAME } from '../symbolTypes';
import { bind, isConstructor, verifyGetterDescriptor, verifySetterDescriptor } from './shared';
...
export function createDeleteProperty(sandbox: Sandbox) {
    return (target: Window, p: PropertyKey) => {
        ...
        //     console.log(`The "${String(p)}" is global protect variable."`);
        //   }
        // }
        return true;
    };
