import { makeMap, isObject, handlerParams } from '../utils';
...
export function verifyGetterDescriptor(target: any, p: PropertyKey, newValue: any) {
...
export function verifySetterDescriptor(target: any, p: PropertyKey, newValue: any) {
    const desc = Object.getOwnPropertyDescriptor(target, p);
...
const buildInProps = makeMap(['length', 'caller', 'callee', 'arguments', 'prototype', Symbol.hasInstance]);
